...
@Sql(statements = {
        ...
        create table verification_record (
            ...
            ticket_id bigint not null, verifier_id bigint not null, result varchar(20) not null,
        ...
        "insert into booking_order values (501, 'ORDER-501', 7, 21), (502, 'ORDER-502', 8, 22)",
        ...
        values
            (801, 'REQ-OLD', 701, 31, 'FAILED', '票券尚未生效', 'GATE-01', CURRENT_TIMESTAMP);
        """
})
