...
@Sql(statements = {
        ...
        create table booking_order (
            ...
            venue_id bigint not null,
            venue_name_snapshot varchar(100) not null,
            venue_address_snapshot varchar(255),
            visit_date date not null,
            start_time time not null,
            end_time time not null,
            purchaser_name_snapshot varchar(50),
            purchaser_phone_snapshot varchar(20),
        ...
        insert into booking_order
            (id, order_no, user_id, session_id, venue_id, venue_name_snapshot,
             venue_address_snapshot, visit_date, start_time, end_time,
             purchaser_name_snapshot, purchaser_phone_snapshot, quantity,
             original_amount, discount_amount, total_amount, status,
             payment_no, paid_at, created_at)
        values
            (501, 'ORDER-501', 7, 21, 10, '景点甲', '测试路 1 号', '2026-08-10', '09:00:00', '11:00:00',
             '游客甲', '13800000001', 1, 80.00, 0.00, 80.00, 'PAID', 'PAY-501',
             '2026-08-01 10:00:00', '2026-08-01 09:00:00'),
            (502, 'ORDER-502', 8, 22, 20, '景点乙', '测试路 2 号', '2026-08-11', '14:00:00', '16:00:00',
             '游客乙', '13800000002', 1, 50.00, 0.00, 50.00, 'PENDING_PAYMENT', null,
             null, '2026-08-01 09:30:00'),
            (503, 'ORDER-503', 7, 21, 10, '景点甲', '测试路 1 号', '2026-08-10', '09:00:00', '11:00:00',
             '游客甲', '13800000001', 1, 80.00, 0.00, 80.00, 'CANCELLED', null,
        ...
        insert into booking_order_item
            (id, order_id, visitor_id, session_ticket_type_id, visitor_name,
             visitor_id_type, visitor_id_number, visitor_fingerprint, ticket_type_name, unit_price)
        values
            (601, 501, 101, 301, '张三', 'ID_CARD',
             '440101199001011234', 'fingerprint-101', '成人票', 80.00),
            (603, 503, 103, 301, '王五', 'ID_CARD',
             '440101199001011235', 'fingerprint-103', '成人票', 80.00);
        """,
        """
